...
clock; the logs showed nothing is posted overnight, so 48 runs a day became
15 for no loss in how quickly a deadline reaches you.) `docs/pi-setup.md` was followed end to end on
